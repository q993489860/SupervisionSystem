    ...
    $(document).ready(function() {
        oTable = $('#editable').DataTable( {
            ...
            "fnServerParams": function ( aoData ) {//向服务器传额外的参数
                ...
                aoData.push( { "name": "state", "value": 3 });
            },
            "aoColumns": [ //这个属性下的设置会应用到所有列，按顺序没有是空
                ...
                { "mData": function(obj){
                    ...
                    operate += '<a class="btn btn-primary" href="${pageContext.request.contextPath}/courseComment/courseCommentEdit?id='+obj.id+'"><i class="fa fa-edit">编辑</i></a> |' +'&nbsp;&nbsp;';
