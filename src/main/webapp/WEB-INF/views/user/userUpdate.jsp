                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form:form class="form-horizontal" commandName="user" method="post"
                                   action="${pageContext.request.contextPath }/user/saveOrUpdateUser?type=update" id="userForm">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <form:input path="phoneNumber" id="phoneNumber" class="form-control" onblur="this.value=this.value.trim()" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <form:select path="department.id"  class="form-control departmentRequierd">
                                        <form:option value="">请选择</form:option>
...
//            alert("id:"+$("#id").val());
                $.ajax({
                    url: "${pageContext.request.contextPath}/user/checkMobilePhoneExist?tel="+$("#phoneNumber").val()+"&id="+$("#id").val(),
                    type: "GET",
                    dataType: "json",
                    async:false,
                    cache: false,
...
//            alert("id:"+$("#id").val());
                $.ajax({
                    url: "${pageContext.request.contextPath}/user/checkUserCodeExist?userCode="+$("#userCode").val()+"&id="+$("#id").val(),
                    type: "GET",
                    dataType: "json",
                    async:false,
                    cache: false,
