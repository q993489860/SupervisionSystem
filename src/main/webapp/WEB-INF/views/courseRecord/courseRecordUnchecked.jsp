            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        ...
                        <p>
                            <button class="btn btn-info" type="button" onclick="fnClickPass();"><i
    ...
    $(document).ready(function () {
        oTable = $('#editable').DataTable({
            ...
            "fnServerParams": function (aoData) {//向服务器传额外的参数
                ...
                //状态为1，表明这是未审核的课堂记录
                aoData.push({"name": "state", "value": 1});
            },
            "aoColumns": [ //这个属性下的设置会应用到所有列，按顺序没有是空
                ...
                {"mData": "score"},
                {
                    "mData": function (obj) {
                        ...
                        operate += '<button class="btn btn-info" onclick="fnClickPassOne(this);" value="' + obj.id + '"><i class="fa fa-check">通过</i> </button> | ' + '&nbsp;&nbsp;';
                        operate += '<button class="btn btn-info" onclick="fnClickUnPassOne(this);" value="' + obj.id + '"><i class="fa fa-times">不通过</i> </button>' + '&nbsp;&nbsp;';
                        return operate;
                    }
                }
            ],
